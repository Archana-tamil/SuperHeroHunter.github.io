...
function addFavourite(id) {
  if (!arr.includes(id) == true) {
    ...
    alert("Your SuperHero added in favourites Successfully")
  }else{
    alert("Your SuperHero is Already in Favourites")
  }
}
...
function connection() {
  ...
  // INCASE OF LOAD END
     ...
     // http://gateway.marvel.com/v1/public/comics?ts=1&apikey=703edbacd2c1816123673844200afc80&hash=cbf28ad596f71ff0ecfede4847071b1c
      xhr.open("GET", `https://gateway.marvel.com/v1/public/characters?${params}&ts=1&apikey=703edbacd2c1816123673844200afc80&hash=cbf28ad596f71ff0ecfede4847071b1c`, true);
